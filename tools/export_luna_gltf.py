"""Export Luna and his clips out of Blender as glTF.

Run inside Blender (Luna.blend on the Windows host), the same way
...
Or let tools/build_luna.py do both halves headless, which is the same thing
...
OUT = r"\\wsl.localhost\Ubuntu\home\bob\mario\assets\luna\luna_raw.glb"
...
if __name__ == "__main__":
    ...
    ap = argparse.ArgumentParser(prog="export_luna_gltf")
