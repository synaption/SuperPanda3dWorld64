...
> [Documentation home](README.md) · [Quick start](../README.md) · [Aiming and
> attack animation design](aim.md)

This is the detailed technical and design reference for the project. For a
quick overview and launch instructions, see the [root README](../README.md).
